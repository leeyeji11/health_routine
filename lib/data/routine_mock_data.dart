...
class RoutineMockData {
  static final List<Routine> workoutData = [
    // 🔹 초급 루틴 (easy)
    Routine(
      ...
      time: 10,
      category: "유산소",
      image: Assets.images.calenderList.stretching.path,
    ...
    Routine(
      ...
      time: 20,
      category: "근력",
      image: Assets.images.calenderList.latPullDown.path,
      difficulty: Difficulty.easy,
      startDate: DateTime(2024, 2, 27),
    ...
    Routine(
      ...
      time: 20,
      category: "근력",
      image: Assets.images.calenderList.squat.path,
      difficulty: Difficulty.easy,
      startDate: DateTime(2024, 2, 27),
    ...
    Routine(
      ...
      time: 15,
      category: "유산소",
      image: Assets.images.calenderList.running.path,
      difficulty: Difficulty.easy,
      startDate: DateTime(2024, 2, 27),
